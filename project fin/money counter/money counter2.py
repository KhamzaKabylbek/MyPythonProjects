...
def displayTotalMoney(img, totalMoney):
    cv2.rectangle(img, (20, 20), (250, 90), (0, 0, 0), -1)
    cv2.putText(img, f'Total Money: Rs.{totalMoney}', (30, 70), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2,
                cv2.LINE_AA)
...
while True:
    ...
    displayTotalMoney(img, totalMoney)
